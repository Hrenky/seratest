 ...
 * @method static EloquentBuilder create($attributes = [])
 ...
 * @method static EloquentModel|EloquentBuilder firstOrCreate(array $attributes = [], array $values = []) Get the first record matching the attributes or create it.
 * @method static EloquentModel|EloquentBuilder firstOrNew(array $attributes = [], array $values = []) Get the first record matching the attributes or instantiate it.
 *
 *
